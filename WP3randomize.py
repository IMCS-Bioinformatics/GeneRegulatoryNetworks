...
class randomizeMotifs:
    def __init__(self, templ):
        ...
        self.motifSets = {}
    def initData(self):
        self.links = CReader.readJson(self.template["fileInput"])
        self.proteinList = CReader.readJson(self.template["fileInputProteins"])
        self.updateCand()
    ...
    def saveRandomize(self):
        ...
        CReader.saveJson(self.template["fileOutput"] , self.randomizedData)
    def readRandomize(self):
        randomizedData = CReader.readJson(self.template["fileOutput"])
