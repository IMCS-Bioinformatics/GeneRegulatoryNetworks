...
class utilsMotifs:
    ...
    def initStatsData(self):
        self.links = CReader.readJson(self.template["fileInputLinks"])
        self.randomizedMotifs = CReader.readJson(self.template["fileMotifRandomized"])
        self.ohnologues = CReader.readJson(self.template["fileInputOhnoloque"])
    ...
    def addNormalizationByLinks(self, rez):
        ...
        CReader.saveCsv(self.template["fileOutputStats"], rez)
    def finalStats(self):
        self.initStatsData()
